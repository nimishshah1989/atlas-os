...
def run() -> None:
    ...
    show = ["RELIANCE", "HDFCBANK", "TCS", "INFY", "ICICIBANK", "SBIN", "BHARTIARTL",
            "TATASTEEL", "DIXON", "PERSISTENT", "KPITTECH", "CDSL", "POLYCAB"]
    hdr = (f"{'symbol':12s} {'cap':6s} {'sector':16s} " + " ".join(f"{c[:4]:>4s}" for c in dc.CONV)
    ...
    print("  legend: D10 = #conviction lenses in TOP decile; D9+ = # in top-2 deciles; "
