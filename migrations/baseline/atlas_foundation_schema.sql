...
--
-- Name: atlas_etf_metrics_daily; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_etf_metrics_daily (
...
--
-- Name: atlas_etf_scorecard; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_etf_scorecard (
    id uuid,
    snapshot_date date,
    instrument_id uuid,
    isin character varying(16),
    ticker character varying(32),
    etf_name character varying(256),
    etf_category character varying(32),
    underlying_sector character varying(64),
    matrix_conviction_score numeric(6,2),
    sector_strength_score numeric(6,2),
    tracking_quality_score numeric(6,2),
    aum_bracket_score numeric(6,2),
    liquidity_score numeric(6,2),
    expense_ratio_score numeric(6,2),
    ...
    raw_metrics jsonb,
    created_at timestamp with time zone,
    premium_bps numeric(8,2),
    te_60d numeric(8,4),
    adv_20d_inr numeric(18,2)
);


--
-- Name: atlas_etf_signal_calls; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_etf_signal_calls (
    etf_signal_call_id uuid,
...
--
-- Name: atlas_fund_metrics_daily; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_fund_metrics_daily (
    ...
    created_at timestamp with time zone,
    updated_at timestamp with time zone,
    nav_state character varying(24)
);


--
-- Name: atlas_fund_scorecard; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_fund_scorecard (
    id uuid,
    snapshot_date date,
    scheme_code character varying(32),
    isin character varying(16),
    fund_name character varying(256),
    fund_category character varying(64),
    fund_style character varying(32),
    amc character varying(128),
    risk_adjusted_return_score numeric(6,2),
    holdings_conviction_score numeric(6,2),
    style_sector_score numeric(6,2),
    cost_manager_score numeric(6,2),
    composite_score numeric(6,2),
    rank_in_category integer,
    category_size integer,
    is_atlas_leader boolean,
    ...
    survivorship_exposure_pct numeric(6,2),
    nav_as_of date,
    holdings_as_of date,
    eli5 text,
    sub_metrics jsonb,
...
--
-- Name: atlas_fund_states_daily; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_fund_states_daily (
    mstar_id character varying(32),
    date date,
    nav_state character varying(32),
    composition_state character varying(32),
    holdings_state character varying(32),
    nav_state_as_of date,
...
--
-- Name: atlas_scorecard_daily; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_scorecard_daily (
    id uuid,
    date date,
    instrument_id uuid,
    rs_residual_6m numeric(12,6),
    log_med_tv_60d numeric(12,6),
    realized_vol_60d numeric(10,6),
    formation_max_dd numeric(8,6),
    listing_age_days integer,
    log_price numeric(10,6),
    features jsonb,
...
--
-- Name: atlas_sector_metrics_daily; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_sector_metrics_daily (
    sector_name character varying(64),
    date date,
    ...
    topdown_index_code character varying(32),
    ...
    created_at timestamp with time zone,
    updated_at timestamp with time zone,
    bottomup_ret_1w numeric(10,4),
    rs_velocity numeric(10,6),
    rs_1w numeric(10,4),
    rs_1m numeric(10,4),
    rs_6m numeric(10,4),
    rs_12m numeric(10,4),
    pct_above_ema20 numeric(5,2),
    pct_above_ema200 numeric(5,2),
    pct_52wh numeric(5,2),
    hhi numeric(8,2),
    bottomup_rs_1d_nifty500 numeric(10,4),
    bottomup_rs_1w_nifty500 numeric(10,4),
    bottomup_rs_1m_nifty500 numeric(10,4),
    bottomup_rs_6m_nifty500 numeric(10,4),
    bottomup_rs_12m_nifty500 numeric(10,4),
    bottomup_rs_24m_nifty500 numeric(10,4),
    pct_above_ema21 numeric(6,4),
    bottomup_ret_12m numeric(10,4)
);


--
-- Name: atlas_sector_states_daily; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_sector_states_daily (
    sector_name character varying(64),
    date date,
    sector_state character varying(16),
    bottomup_state character varying(16),
    topdown_state character varying(16),
    divergence_flag boolean,
    bottomup_rs_state character varying(16),
    bottomup_momentum_state character varying(16),
...
--
-- Name: atlas_signal_calls; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_signal_calls (
    signal_call_id uuid,
    instrument_id uuid,
    scorecard_id uuid,
    date date,
...
--
-- Name: atlas_signal_ic; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_signal_ic (
    id uuid,
    signal_name character varying(64),
    timeframe character varying(16),
    forward_period_days integer,
    rolling_window character varying(8),
    as_of_date date,
...
--
-- Name: atlas_signal_weights; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_signal_weights (
    id uuid,
...
--
-- Name: atlas_stock_conviction_daily; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_stock_conviction_daily (
    instrument_id uuid,
    date date,
    tier character varying(32),
    ...
    weight_set_version character varying(96),
    computed_at timestamp with time zone,
    created_at timestamp with time zone,
    updated_at timestamp with time zone
);
...
--
-- Name: atlas_stock_metrics_daily; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_stock_metrics_daily (
    instrument_id uuid,
    date date,
    ret_1d numeric(10,4),
    ret_1w numeric(10,4),
    ...
    updated_at timestamp with time zone,
    ret_24m numeric(10,4),
    rs_1d_tier numeric(10,4),
    rs_24m_tier numeric(10,4),
    rs_1d_tier_gold numeric(10,4),
    rs_6m_tier_gold numeric(10,4),
    rs_12m_tier_gold numeric(10,4),
    rs_24m_tier_gold numeric(10,4)
);
...
--
-- Name: atlas_universe_etfs; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.atlas_universe_etfs (
    ticker character varying(32),
    isin character varying(16),
    fund_house character varying(128),
    etf_name character varying(256),
    theme character varying(16),
    linked_sector character varying(64),
    linked_index character varying(32),
...
--
-- Name: backfill_state; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.backfill_state (
    instrument_id uuid NOT NULL,
...
--
-- Name: corp_action; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.corp_action (
    instrument_id uuid NOT NULL,
    symbol text NOT NULL,
...
--
-- Name: corp_action_event; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.corp_action_event (
    symbol text NOT NULL,
    ex_date date NOT NULL,
...
--
-- Name: de_trading_calendar; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.de_trading_calendar (
    date date,
    is_trading boolean,
...
--
-- Name: ingest_run; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.ingest_run (
...
--
-- Name: mv_etf_deepdive; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.mv_etf_deepdive (
    as_of_date date,
    ticker character varying(32),
    isin character varying(16),
    instrument_id uuid,
    ...
    etf_category character varying(32),
    underlying_sector character varying(64),
    matrix_conviction_score numeric,
    sector_strength_score numeric,
    tracking_quality_score numeric,
    aum_bracket_score numeric,
    liquidity_score numeric,
    expense_ratio_score numeric,
    ...
    drawdown_ratio_252 numeric,
    volume_expansion numeric,
    rs_state character varying(32),
    momentum_state character varying(32),
    risk_state character varying(32),
    volume_state character varying(32),
...
--
-- Name: mv_etf_list_v6; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.mv_etf_list_v6 (
    as_of_date date,
    ticker character varying(32),
    isin character varying(16),
    instrument_id uuid,
    ...
    rs_1m numeric,
    rs_3m numeric,
    rs_pctile_1w numeric,
    rs_pctile_1m numeric,
    rs_pctile_3m numeric,
    realized_vol_63 numeric,
    drawdown_ratio_252 numeric,
    volume_expansion numeric,
    avg_volume_20 numeric(20,2),
    ...
    state_since_date date,
    is_investable boolean,
    strength_gate boolean,
    direction_gate boolean,
    risk_gate boolean,
    sector_gate boolean,
    market_gate boolean,
    transition_trigger boolean,
    breakout_trigger boolean,
    proximity_pass boolean,
    position_size_pct numeric,
    market_multiplier numeric,
    risk_multiplier numeric,
    exit_market_riskoff boolean,
    exit_sector_avoid boolean,
    exit_rs_deteriorate boolean,
    exit_momentum_collapse boolean,
    exit_stop_loss boolean,
    cell_id uuid,
    signal_predicted_excess numeric,
    signal_confidence numeric,
    signal_fire_date date,
    action text,
    adv_monthly_cr numeric,
    scatter_zone text,
    refreshed_at timestamp with time zone
);
...
--
-- Name: mv_markets_rs_grid; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.mv_markets_rs_grid (
    rank_order integer,
    baseline_name text,
    latest_close_inr numeric,
    as_of_date date,
    ret_1w numeric,
    ret_1m numeric,
    ret_3m numeric,
...
--
-- Name: mv_stock_landscape_trader; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.mv_stock_landscape_trader (
    as_of_date date,
    instrument_id uuid,
    symbol character varying(32),
    company_name character varying(256),
...
--
-- Name: technical_stock; Type: TABLE; Schema: atlas_foundation; Owner: -
--

CREATE TABLE atlas_foundation.technical_stock (
    instrument_id uuid NOT NULL,
    date date NOT NULL,
    ema_21 numeric(18,6),
    ema_50 numeric(18,6),
...
--
-- Name: backfill_state backfill_state_pkey; Type: CONSTRAINT; Schema: atlas_foundation; Owner: -
--

ALTER TABLE ONLY atlas_foundation.backfill_state
    ADD CONSTRAINT backfill_state_pkey PRIMARY KEY (instrument_id);
...
--
-- Name: corp_action_event corp_action_event_pkey; Type: CONSTRAINT; Schema: atlas_foundation; Owner: -
--

ALTER TABLE ONLY atlas_foundation.corp_action_event
    ADD CONSTRAINT corp_action_event_pkey PRIMARY KEY (symbol, ex_date, event_type);


--
-- Name: corp_action corp_action_pkey; Type: CONSTRAINT; Schema: atlas_foundation; Owner: -
--

ALTER TABLE ONLY atlas_foundation.corp_action
    ADD CONSTRAINT corp_action_pkey PRIMARY KEY (instrument_id, ex_date, action_type);
...
--
-- Name: ingest_run ingest_run_pkey; Type: CONSTRAINT; Schema: atlas_foundation; Owner: -
--

ALTER TABLE ONLY atlas_foundation.ingest_run
...
--
-- Name: technical_stock technical_stock_pkey; Type: CONSTRAINT; Schema: atlas_foundation; Owner: -
--

ALTER TABLE ONLY atlas_foundation.technical_stock
    ADD CONSTRAINT technical_stock_pkey PRIMARY KEY (instrument_id, date);
...
--
-- Name: ix_atlas_etf_scorecard_instrument_id; Type: INDEX; Schema: atlas_foundation; Owner: -
--

CREATE INDEX ix_atlas_etf_scorecard_instrument_id ON atlas_foundation.atlas_etf_scorecard USING btree (instrument_id);


--
-- Name: ix_atlas_etf_scorecard_snapshot_date; Type: INDEX; Schema: atlas_foundation; Owner: -
--

CREATE INDEX ix_atlas_etf_scorecard_snapshot_date ON atlas_foundation.atlas_etf_scorecard USING btree (snapshot_date);


--
-- Name: ix_atlas_etf_scorecard_ticker; Type: INDEX; Schema: atlas_foundation; Owner: -
--

CREATE INDEX ix_atlas_etf_scorecard_ticker ON atlas_foundation.atlas_etf_scorecard USING btree (ticker);


--
-- Name: ix_atlas_fund_metrics_daily_mstar_id; Type: INDEX; Schema: atlas_foundation; Owner: -
--

CREATE INDEX ix_atlas_fund_metrics_daily_mstar_id ON atlas_foundation.atlas_fund_metrics_daily USING btree (mstar_id);


--
-- Name: ix_atlas_fund_scorecard_scheme_code; Type: INDEX; Schema: atlas_foundation; Owner: -
--

CREATE INDEX ix_atlas_fund_scorecard_scheme_code ON atlas_foundation.atlas_fund_scorecard USING btree (scheme_code);


--
-- Name: ix_atlas_fund_scorecard_snapshot_date; Type: INDEX; Schema: atlas_foundation; Owner: -
--

CREATE INDEX ix_atlas_fund_scorecard_snapshot_date ON atlas_foundation.atlas_fund_scorecard USING btree (snapshot_date);


--
-- Name: ix_atlas_fund_states_daily_date; Type: INDEX; Schema: atlas_foundation; Owner: -
--

CREATE INDEX ix_atlas_fund_states_daily_date ON atlas_foundation.atlas_fund_states_daily USING btree (date);


--
-- Name: ix_atlas_fund_states_daily_mstar_id; Type: INDEX; Schema: atlas_foundation; Owner: -
--

CREATE INDEX ix_atlas_fund_states_daily_mstar_id ON atlas_foundation.atlas_fund_states_daily USING btree (mstar_id);
...
--
-- Name: ix_fs_secmetrics_d; Type: INDEX; Schema: atlas_foundation; Owner: -
--

CREATE INDEX ix_fs_secmetrics_d ON atlas_foundation.atlas_sector_metrics_daily USING btree (date);


--
-- Name: ix_fs_secstates_d; Type: INDEX; Schema: atlas_foundation; Owner: -
--

CREATE INDEX ix_fs_secstates_d ON atlas_foundation.atlas_sector_states_daily USING btree (date);


--
-- Name: ix_fs_sigcalls_iid; Type: INDEX; Schema: atlas_foundation; Owner: -
--

CREATE INDEX ix_fs_sigcalls_iid ON atlas_foundation.atlas_signal_calls USING btree (instrument_id);
...
--
-- Name: ix_fs_univ_etfs_ticker; Type: INDEX; Schema: atlas_foundation; Owner: -
--

CREATE INDEX ix_fs_univ_etfs_ticker ON atlas_foundation.atlas_universe_etfs USING btree (ticker);
