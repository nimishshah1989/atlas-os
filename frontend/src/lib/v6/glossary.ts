...
export const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  strength: { title: 'Strength (avg decile)', body: 'Average of the four scored-lens deciles — Technical, Fundamental, Catalyst, Flow — on a 1–10 scale. The headline conviction read; a high average means the name leads on several lenses, not just one.' },
  lead: { title: 'Leadership count', body: 'How many of the four conviction lenses the stock leads — i.e. sits in the top three deciles (D≥8) of its cap cohort. Ranges 0–4; a NULL lens counts as not-leading.' },
  ...
  leaders_count: { title: 'Leaders', body: 'Holdings that are multi-factor leaders — top-decile in ≥2 conviction lenses. The base for leadership-breadth.' },
  expense: { title: 'Expense ratio', body: 'The fund’s annual expense ratio (%). A direct, certain drag on net return — lower is cheaper.' },
  cat_rank: { title: 'Category rank', body: 'Rank within the fund’s SEBI category by Atlas fund score, computed over the funds shown here (N of M). 1 = best in category. Ties broken by leadership-breadth, so every fund has a distinct position.' },
  fund_score: { title: 'Fund score (composite)', body: 'Derived 0–100 composite of the fund’s holdings-weighted lenses — the SAME blend as a sector or stock: 0.30·Technical + 0.25·Fundamental + 0.25·Flow + 0.20·Catalyst, renormalised over the lenses present. Click the score to see the derivation. Valuation is context, not scored.' },
