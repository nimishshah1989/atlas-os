...
export const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  cat_rank: { title: 'Category rank', body: 'Rank within the fund’s SEBI category by Atlas fund score, computed over the funds shown here (N of M). 1 = best in category.' },
  fund_score: { title: 'Fund score (composite)', body: 'Atlas fund scorecard, 0–100 — a blend of risk-adjusted return, holdings conviction, style/sector fit and cost. Higher = stronger overall.' },
