...
//
// Direct Supabase queries for the v6 Sectors pages — all native from atlas_foundation.
//
// Query functions for /sectors (Page 04) and /sectors/[sector] (Page 04a):
...
// getSectorsForDate / ScreenSector (the old atlas_sector_states_daily +
// atlas_sector_metrics_daily read) were removed 2026-07-03 — no live page rendered them
// (only a mocked unit test), and both source tables are retired/dropped. The live sectors
// pages read mv_sector_cards/breadth/deepdive + getAllSectorConstituents above.
