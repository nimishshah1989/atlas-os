// One model book on the confirmations tab: what it holds today, which positions are
        ...
        <>
          ...
          {book.length > TOP_N && (
            <Link
              href={
                latestPublished
                  ? `/portfolios/confirmations/${code}/${latestPublished.weekOf}/report`
                  : `/portfolios/confirmations/${code}/${thisMonday}`
              }
