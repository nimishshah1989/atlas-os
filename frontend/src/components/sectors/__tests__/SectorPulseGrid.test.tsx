// frontend/src/components/sectors/__tests__/SectorPulseGrid.test.tsx
...
vi.mock('@/lib/queries/sector_index_rs', () => ({}))
vi.mock('server-only', () => ({}))
...
import type { SectorIndexRsPayload, SectorIndexRet, WindowRet } from '@/lib/queries/sector_index_rs'
