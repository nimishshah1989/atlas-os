      ...
      <div>
        ...
        {metricHistory.length === 0 ? (
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-4 items-start">
              <IndicatorChart
                title="EMA 10 Ratio (vs Benchmark)"
                description="Ratio of this stock's 10-day EMA to the benchmark EMA. Above 1.0 means the stock's short-term momentum leads the benchmark."
