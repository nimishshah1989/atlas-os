// frontend/src/components/v6/skeletons/__tests__/SkeletonETFs.test.tsx
// Schema: 4 top-level children (header strip, industry snapshot, charts, ranked table)

import { describe, it, expect } from 'vitest'
import { render, screen } from '@testing-library/react'
import { SkeletonETFs } from '../SkeletonETFs'

describe('SkeletonETFs', () => {
  ...
  it('accepts className prop without error', () => {
    const { container } = render(<SkeletonETFs className="test-class" />)
