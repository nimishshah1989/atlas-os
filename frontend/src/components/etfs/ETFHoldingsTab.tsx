...
export function ETFHoldingsTab({ holdings }: { holdings: ETFHoldingRow[] }) {
        ...
        <table className="w-full font-sans text-xs border-collapse">
          <thead>
            <tr className="border-b border-paper-rule bg-paper">
              ...
              <th className="px-3 py-2 text-right font-semibold text-ink-tertiary uppercase tracking-wider text-[10px]" title="Portfolio weight of this holding as a % of ETF AUM at the last disclosure date">Weight</th>
