// frontend/src/components/health/FreshnessTable.tsx
import type { TableFreshness } from '@/lib/queries/health'
import { lagThresholdDays } from '@/lib/queries/health'
...
export function FreshnessTable({ rows }: { rows: TableFreshness[] }) {
  return (
            ...
            {rows.map((row) => (
              ...
              >
                ...
                <td className="py-2 pr-4">
                  {lagPill(row.lag_days, lagThresholdDays(row.table_name))}
                </td>
