// POST /api/confirmations/cap — set a book's max position cap %. Stored in
...
import { setMaxCap } from '@/lib/queries/confirmations'
...
export async function POST(req: Request) {
  ...
  const saved = await setMaxCap(code as PortfolioCode, capPct)
