// POST /api/confirmations/save — replace a draft's rows. Deliberately permissive:
...
import { saveDraft, type CallRow, type EvidenceSection } from '@/lib/queries/confirmations'
...
export async function POST(req: Request) {
  ...
  try {
    const { confirmationId } = await saveDraft(code as PortfolioCode, week, { calls, evidence })
