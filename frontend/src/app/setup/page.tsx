  ...
  return (
    <main className="min-h-screen bg-paper px-8 py-6 max-w-4xl mx-auto">
      <header className="mb-8">
        <h1 className="font-serif text-2xl text-ink-primary">Setup</h1>
        <p className="font-sans text-sm text-ink-secondary mt-2 max-w-xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <Link
          href="/setup/policy"
          className="group block p-5 border border-paper-rule rounded-[3px] bg-paper hover:border-accent/40 transition-colors"
          aria-label="Policy — edit house-default and per-portfolio trade rules"
        >
          <h2 className="font-sans text-base font-semibold text-ink-primary group-hover:text-accent transition-colors">
            Policy
          </h2>
          ...
          <span className="mt-3 inline-block font-sans text-xs text-accent">
            Go to Policy →
          </span>
        </Link>
